  ...
  const generate = async () => {
    ...
    try {
      const res = await fetch('/api/followup', {
        ...
        body: JSON.stringify({ context, clientName, email, companyProfile: profile }),
      })
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <textarea
              ...
              placeholder="Paste your proposal, or briefly describe what you proposed..."
          ...
          <div>
            ...
            <div className={result ? 'doc-paper h-72 p-6 text-sm leading-relaxed overflow-y-auto' : 'card h-72 p-5 text-sm overflow-y-auto'}>
              {loading ? (
                ...
                <span style={{ color: 'rgba(34,38,47,0.35)' }}>Your follow-up email will appear here…</span>
              )}
            </div>
            {result && (
